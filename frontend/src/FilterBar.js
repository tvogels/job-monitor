    ...
    return (
        <div style={{ display: "flex", flexDirection: "row", ...style }}>
            ...
            <FormGroup style={{ marginLeft: "1em" }}>
                <ButtonGroup>
                    <NavLink className="bp3-button bp3-icon-list" to={`/${project}/config`} activeClassName="bp3-active">
                        Config
                    </NavLink>
                    <NavLink className="bp3-button bp3-icon-database" to={`/${project}/logs`} activeClassName="bp3-active">
                        Logs
                    </NavLink>
                    <NavLink className="bp3-button bp3-icon-chart" to={`/${project}/timeseries`} activeClassName="bp3-active">
                        Timeseries
                    </NavLink>
                    <NavLink className="bp3-button bp3-icon-document" to={`/${project}/reports`} activeClassName="bp3-active">
                        Reports
                    </NavLink>
                    <NavLink className="bp3-button bp3-icon-media" to={`/${project}/images`} activeClassName="bp3-active">
                        Images
                    </NavLink>
                </ButtonGroup>
            </FormGroup>
